...
provincias_espana = {
    ...
    "Álava": ["Burgos", "San Sebastian", "Logroño", "Pamplona", "Bilbao"],
    ...
    "Burgos": ["Álava", "Santander", "Logroño", "Leon", "Palencia", "Soria", "Valladolid", "Bilbao", "Segovia"],
    ...
    "Pamplona": ["Álava", "San Sebastian", "Huesca", "Logroño", "Zaragoza"],
    ...
    "Bilbao": ["Álava", "Santander", "San Sebastian", "Burgos"],
...
provincias_espana = {
    "Andorra": ["Lleida", "Girona"],
    "A Coruña": ["Lugo", "Pontevedra"],
    "Álava": ["Burgos", "San Sebastián", "Logroño", "Pamplona", "Bilbao"],
    ...
    "Burgos": ["Álava", "Santander", "Logroño", "León", "Palencia", "Soria", "Valladolid", "Bilbao", "Segovia"],
    ...
    "Guadalajara": ["Cuenca", "Madrid", "Soria", "Teruel", "Zaragoza", "Segovia"],
    "San Sebastián": ["Álava", "Pamplona", "Bilbao"],
    ...
    "Pamplona": ["Álava", "San Sebastián", "Huesca", "Logroño", "Zaragoza"],
    ...
    "Bilbao": ["Álava", "Santander", "San Sebastián", "Burgos"],
